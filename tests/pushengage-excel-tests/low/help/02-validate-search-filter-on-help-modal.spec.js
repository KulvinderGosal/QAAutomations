...
test.describe('LOW - Help - Validate - Search filter on Help modal', () => {
  
  test('Validate - Search filter on Help modal', async ({ page }) => {
    test.setTimeout(120000);
    
    console.log('📍 Test ID: QAWPREG1102');
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg1102-validate-search-filter-on-help-modal.png`, 
      fullPage: true 
    });
