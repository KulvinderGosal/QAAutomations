...
test.describe('CRITICAL - Settings - Validate - AutoPush Settings - Enable Use post featured image', () => {
  ...
  test('Validate - AutoPush Settings - Enable Use post featured image', async ({ page }) => {
    ...
    // Expected Result:
    // Merchant should be able to Use post featured image
    // for notifications icon
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg927-validate-autopush-settings-enable-use-post-featured-image.png`, 
      fullPage: true 
    });
