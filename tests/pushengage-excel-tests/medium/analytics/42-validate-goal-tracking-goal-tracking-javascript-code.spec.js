...
test.describe('MEDIUM - Analytics - Validate - Goal Tracking - Goal Tracking Javascript code', () => {
  ...
  test('Validate - Goal Tracking - Goal Tracking Javascript code', async ({ page }) => {
    ...
    // Expected Result:
    // After saving/updating Goal Tracking settings, Javascript code should display the Gosal name and option to Copy
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg742-validate-goal-tracking-goal-tracking-javascript-code.png`, 
      fullPage: true 
    });
