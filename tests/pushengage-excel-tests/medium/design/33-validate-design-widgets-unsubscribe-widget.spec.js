...
test.describe('MEDIUM - Design - Validate - Design - Widgets - Unsubscribe widget', () => {
  ...
  test('Validate - Design - Widgets - Unsubscribe widget', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG533');
    ...
    // Expected Result:
    // Clicking Preview button for mobile interface should load an interface modal with Unsubscribe to notification text
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg533-validate-design-widgets-unsubscribe-widget.png`, 
      fullPage: true 
    });
