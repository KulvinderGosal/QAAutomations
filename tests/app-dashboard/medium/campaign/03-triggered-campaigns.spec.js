...
test.describe('MEDIUM - Campaign - Triggered Campaigns', () => {
  ...
  test('should display action buttons on Triggered Campaigns page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate action buttons on Triggered Campaigns');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate action buttons on Triggered Campaigns\n');
  });
