...
test.describe('MEDIUM - Campaign - Drip Autoresponders', () => {
  ...
  test('should display action buttons on Drip Autoresponders page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate action buttons on Drip Autoresponders');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate action buttons on Drip Autoresponders\n');
  });
