...
test.describe('MEDIUM - Site Settings - Site Details', () => {
  ...
  test('should display action buttons on Site Details page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate action buttons on Site Details');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate action buttons on Site Details\n');
  });
