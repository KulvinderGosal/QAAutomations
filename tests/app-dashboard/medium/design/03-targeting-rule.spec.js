...
test.describe('MEDIUM - Design - Targeting Rule', () => {
  ...
  test('should display action buttons on Targeting Rule page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate action buttons on Targeting Rule');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate action buttons on Targeting Rule\n');
  });
