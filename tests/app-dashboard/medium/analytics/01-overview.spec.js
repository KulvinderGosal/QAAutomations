...
test.describe('MEDIUM - Analytics - Overview', () => {
  ...
  test('should display action buttons on Overview page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate action buttons on Overview');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    await page.screenshot({ 
      path: `${config.screenshotPath}/overview-page.png`, 
      fullPage: true 
    });
    
    console.log('✅ Test PASSED - Validate action buttons on Overview\n');
  });
