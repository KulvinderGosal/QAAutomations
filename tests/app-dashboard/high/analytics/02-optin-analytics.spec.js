...
test.describe('HIGH - Analytics - Opt-in Analytics', () => {
  ...
  test('should display key UI elements on Opt-in Analytics page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate key UI elements on Opt-in Analytics');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate key UI elements on Opt-in Analytics\n');
  });
