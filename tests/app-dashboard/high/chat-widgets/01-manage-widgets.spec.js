...
test.describe('HIGH - Chat Widgets - Manage Widgets', () => {
  ...
  test('should display key UI elements on Manage Widgets page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate key UI elements on Manage Widgets');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate key UI elements on Manage Widgets\n');
  });
