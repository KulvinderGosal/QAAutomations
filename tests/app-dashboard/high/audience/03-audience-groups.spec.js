...
test.describe('HIGH - Audience - Audience Groups', () => {
  ...
  test('should display key UI elements on Audience Groups page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate key UI elements on Audience Groups');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate key UI elements on Audience Groups\n');
  });
