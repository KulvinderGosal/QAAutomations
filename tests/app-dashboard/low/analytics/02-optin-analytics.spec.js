...
test.describe('LOW - Analytics - Opt-in Analytics', () => {
  ...
  test('should display help text on Opt-in Analytics page', async ({ page }) => {
    test.setTimeout(config.testTimeout);
    
    console.log('🧪 Test: Validate help text on Opt-in Analytics');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    console.log('✅ Test PASSED - Validate help text on Opt-in Analytics\n');
  });
