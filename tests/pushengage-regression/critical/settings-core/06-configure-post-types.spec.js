 ...
 * Test: Configure enabled post types
 * 
 * Status: 📝 TODO
 */

test.describe('CRITICAL - settings-core - Configure enabled post types', () => {
  
  test('Configure enabled post types', async ({ page }) => {
    ...
    // TODO: Navigate to the correct page for Configure enabled post types
    // TODO: Implement test steps for: Configure enabled post types
    ...
    console.log('📝 TODO: Configure enabled post types');
