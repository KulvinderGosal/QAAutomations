...
test.describe('CRITICAL - Campaigns - Validate - Add new - Save as Draft', () => {
  ...
  test('Validate - Add new - Save as Draft', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG338');
    ...
    // Expected Result:
    // A merchant should be allowed to Save A/B notification as draft
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg338-validate-add-new-save-as-draft.png`, 
      fullPage: true 
    });
