...
test.describe('HIGH - PostEditor - Validate - PushEngage Settings Disabled', () => {
  ...
  test('Validate - PushEngage Settings Disabled', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG1826');
    ...
    // Expected Result:
    // If Post Types are disabled under autopush settings, the PushEnage settings should not be displayed on the Page Editor
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg1826-validate-pushengage-settings-disabled.png`, 
      fullPage: true 
    });
