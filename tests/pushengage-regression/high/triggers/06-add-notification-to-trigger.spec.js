 ...
 * Priority: HIGH
 * Feature: TRIGGERS
 * Test: Add notification to trigger
 * 
 * Status: 📝 TODO
 */

test.describe('HIGH - triggers - Add notification to trigger', () => {
  
  test('Add notification to trigger', async ({ page }) => {
    ...
    // TODO: Navigate to the correct page for Add notification to trigger
    // TODO: Implement test steps for: Add notification to trigger
    ...
    console.log('📝 TODO: Add notification to trigger');
