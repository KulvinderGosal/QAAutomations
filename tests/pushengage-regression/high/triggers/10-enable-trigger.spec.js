...
test.describe('HIGH - triggers - Enable trigger', () => {
  
  test('Enable trigger', async ({ page }) => {
    ...
    // TODO: Navigate to the correct page for Enable trigger
    // TODO: Implement test steps for: Enable trigger
    ...
    console.log('📝 TODO: Enable trigger');
