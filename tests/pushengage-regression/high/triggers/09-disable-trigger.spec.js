...
test.describe('HIGH - triggers - Disable trigger', () => {
  
  test('Disable trigger', async ({ page }) => {
    ...
    // TODO: Navigate to the correct page for Disable trigger
    // TODO: Implement test steps for: Disable trigger
    ...
    console.log('📝 TODO: Disable trigger');
