...
test.describe('HIGH - triggers - Duplicate trigger', () => {
  
  test('Duplicate trigger', async ({ page }) => {
    ...
    // TODO: Navigate to the correct page for Duplicate trigger
    // TODO: Implement test steps for: Duplicate trigger
    ...
    console.log('📝 TODO: Duplicate trigger');
