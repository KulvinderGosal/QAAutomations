...
test.describe('MEDIUM - Analytics - Validate - Search filter on Help modal', () => {
  
  test('Validate - Search filter on Help modal', async ({ page }) => {
    test.setTimeout(120000);
    
    console.log('📍 Test ID: QAWPREG704');
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg704-validate-search-filter-on-help-modal.png`, 
      fullPage: true 
    });
