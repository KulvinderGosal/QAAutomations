...
test.describe('MEDIUM - Analytics - Validate - View Documentation modal', () => {
  
  test('Validate - View Documentation modal', async ({ page }) => {
    test.setTimeout(120000);
    
    console.log('📍 Test ID: QAWPREG706');
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg706-validate-view-documentation-modal.png`, 
      fullPage: true 
    });
