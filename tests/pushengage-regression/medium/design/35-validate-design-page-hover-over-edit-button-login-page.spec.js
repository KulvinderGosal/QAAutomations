...
test.describe('MEDIUM - Design - Validate - Design Page - Hover Over Edit Button -Login page', () => {
  ...
  test('Validate - Design Page - Hover Over Edit Button -Login page', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG535');
    ...
    // Expected Result:
    // Clicking  Edit button should take the merchant to PushEngage Dashboard App page on Edit Widget page if logged in otherwise should display login page
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg535-validate-design-page-hover-over-edit-button-login-page.png`, 
      fullPage: true 
    });
