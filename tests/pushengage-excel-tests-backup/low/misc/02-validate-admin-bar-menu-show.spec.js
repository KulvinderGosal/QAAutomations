...
test.describe('LOW - Misc - Validate - Admin bar menu - Show', () => {
  ...
  test('Validate - Admin bar menu - Show', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG3002');
    ...
    // Expected Result:
    // Under Misc settings, unchecking the checkbox should enable the PushEngage Admin bar menu
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg3002-validate-admin-bar-menu-show.png`, 
      fullPage: true 
    });
