...
test.describe('HIGH - PostEditor - Validate - Default UTM parameter', () => {
  ...
  test('Validate - Default UTM parameter', async ({ page }) => {
    ...
    console.log('📍 Test ID: QAWPREG1821');
    ...
    // Expected Result:
    // The default parameter values added under Default Settings should be reflected on the UTM parameters on the Post Editor
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg1821-validate-default-utm-parameter.png`, 
      fullPage: true 
    });
