...
test.describe('CRITICAL - Dashboard - Validate - View Documentation modal', () => {
  
  test('Validate - View Documentation modal', async ({ page }) => {
    test.setTimeout(120000);
    
    console.log('📍 Test ID: QAWPREG209');
    ...
    await page.screenshot({ 
      path: `test-results/qawpreg209-validate-view-documentation-modal.png`, 
      fullPage: true 
    });
